...
/** 
* The FlowDiffuseMatcherT implements the fast diffusion based optical flow based on
...
*/
template<typename T>
class FlowDiffuseMatcherT : public FlowGlobalMatcherT<T>
{
public:

  FlowDiffuseMatcherT(); /**< Default constructor with no parameters */

  virtual ~FlowDiffuseMatcherT(); /**< Destructor */
  ...
  */
  virtual bool doMatching(ImageT<T> & i1, ImageT<T> & i2, double minshiftX, double maxshiftX, double minshiftY, double maxshiftY, ImageT<double> & u1, ImageT<double> & v1, ImageT<double> & o1, ImageT<double> & u2, ImageT<double> & v2,  ImageT<double> & o2);
...
template<typename T>
FlowDiffuseMatcherT<T>::FlowDiffuseMatcherT()
{
}
...
template<typename T>
bool FlowDiffuseMatcherT<T>::doMatching(ImageT<T> & i1, ImageT<T> & i2, double minshiftX, double maxshiftX, double minshiftY, double maxshiftY, ImageT<double> & u1, ImageT<double> & v1, ImageT<double> & o1, ImageT<double> & u2, ImageT<double> & v2,  ImageT<double> & o2)
{
  int height, width, channels;
  int i,j,iproj,jproj;

  ImageT<double> iMatch, iGoodnessVert, iGoodnessHoriz, iGoodnessL, iGoodnessR, bestprobabL, bestprobabR, bestprobabRshifted;
...
template<typename T>
bool FlowDiffuseMatcherT<T>::setParams(int nparams, double*params)
{
  return true;
}

template<typename T>
void FlowDiffuseMatcherT<T>::setLocalImageMatcher(LocalMatcherT<T> & localImageMatcher)
{
  mLocalMatcher = &localImageMatcher;
}

template<typename T>
void FlowDiffuseMatcherT<T>::computeGoodnessHoriz(const ImageT<double> & iMatch, const ImageT<double> & iConductivity, ImageT<double> & iGoodness)
{
...
template<typename T>
void FlowDiffuseMatcherT<T>::computeGoodnessVert(const ImageT<double> & iMatch, const ImageT<double> & iConductivity, ImageT<double> & iGoodness)
{
  int i, j, height, width, channels;
