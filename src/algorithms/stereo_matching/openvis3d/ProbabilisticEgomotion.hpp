...
/**
@see compute3Dmotion(ImageAdapter & image1, ImageAdapter & image2, float f, float pp_x, float pp_y, int numpoints, int numsearches)
*/
typedef struct 
{
...
/**
* @fn MotionParameters compute3Dmotion(ImageAdapter & image1, ImageAdapter & image2, float f, float pp_x, float pp_y, int numpoints=500, int numsearches=100);
...
*/
MotionParameters compute3Dmotion(ImageAdapter & image1, ImageAdapter & image2, float f, float pp_x, float pp_y, int numpoints=500, int numsearches=100);
