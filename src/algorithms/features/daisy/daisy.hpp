...
public:
   ...
   inline int* get_orientation_map() { return m_orientation_map; }
   ...
   inline int compute_descriptor_memory() { return m_w * m_h * m_descriptor_size; }

   /// returns the amount of memory needed for workspace. call before initialize()
   inline int compute_workspace_memory() { return (g_cube_number+1)* m_cube_size; }
