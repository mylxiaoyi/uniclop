    ...
    void apply( const View& view )
    {
        ...
        case PNG_COLOR_TYPE_GRAY:
        {
            ...
            case 8:
                ...
                break;
            case 16:
                read_rows< gray16_pixel_t >( view );
                break;
            default:
                io_error("png_reader::read_data(): unknown combination of color type and bit depth");
            }
        ...
        case PNG_COLOR_TYPE_GA:
        {
            ...
            {
            case 8:
                read_rows< gray_alpha8_pixel_t > ( view );
                break;
            case 16:
                read_rows< gray_alpha16_pixel_t >( view );
                break;
            default:
                io_error("png_reader::read_data(): unknown combination of color type and bit depth");
            }
        ...
        case PNG_COLOR_TYPE_RGBA:
        {
            ...
            {
            case 8 :
                read_rows< rgba8_pixel_t > ( view );
                break;
            case 16:
                read_rows< rgba16_pixel_t >( view );
                break;
            default:
                io_error("png_reader_color_convert::read_data(): unknown combination of color type and bit depth");
            }
